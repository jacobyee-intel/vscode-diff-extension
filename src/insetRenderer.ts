...
.row{box-sizing:border-box;position:relative;display:block;min-height:0;flex:1 1 0;white-space:pre;}
.marker{position:absolute;right:.75em;top:50%;transform:translateY(-50%);pointer-events:none;color:var(--vscode-branchDiff-deletedLineForeground,var(--vscode-gitDecoration-deletedResourceForeground,var(--vscode-errorForeground)));}
.text{display:block;min-width:0;white-space:pre;tab-size:${style.tabSize};-moz-tab-size:${style.tabSize};}
</style>
</head>

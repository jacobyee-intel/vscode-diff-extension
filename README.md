...
Version 0.2.2 uses VS Code's proposed `editorInsets` API. A manually installed
...
npm run verify:vsix -- branch-diff-0.2.2.vsix
```
...
Install `branch-diff-0.2.2.vsix` using **Extensions: Install from VSIX...**,
